...
class ValuationEngineProductOvernightIndexBasisSwap(ValuationEngineProduct):
    ...
    def grad_at_par(self) -> np.ndarray:
        ...
        """
        # The computation is actually p similar to that of the RFR swap, 
        # Just that the denominator is now the differecne between leg 2 engine and leg1 wo basis engine, instead of just 1 egine
        local_grad = []
        self.model_.resize_gradient(local_grad)
